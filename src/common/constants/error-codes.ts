export const ErrorCode = {
  ...
  PLAN_NOT_DAY_PASS: 'PLAN_NOT_DAY_PASS',
  PLAN_DAY_PASS_TERMS: 'PLAN_DAY_PASS_TERMS',
  DAY_PASS_NO_FREEZE: 'DAY_PASS_NO_FREEZE',
  DAY_PASS_MEMBER_REQUIRED: 'DAY_PASS_MEMBER_REQUIRED',
